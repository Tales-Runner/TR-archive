...
export const DOSSIERS: Dossier[] = [
  ...
  // ── 왕실 계열 ─────────────────────────────────
  {
    ...
    relations: [
      ...
      { targetName: "시오넬", targetId: 65, type: "연관", label: "시오넬은 기쁨의 왕국 왕자, 사브리나도 기쁨의 나라 출신", source: "공식 프로필" },
    ],
  ...
  },
  {
    ...
    relations: [
      ...
      { targetName: "라라", targetId: 62, type: "연관", label: "기쁨의 왕국 왕자 / 라라의 어머니도 기쁨의 나라 출신", source: "공식 프로필" },
    ],
    storyArcIds: ["emotion"],
    trivia: [
  ...
  // ── 저승 ───────────────────────────────────────
  {
    ...
    storyArcIds: [],
    trivia: [
      "이승에서 운명을 거스른 죄를 지은 대가로 저승차사가 됨",
  ...
  // ── 티티 ───────────────────────────────────────
  {
    ...
    elimsNote: "아린에게 맡겨진 혼혈 소녀야. 프로필을 보면 모두에게 괄시받다가 아린의 연금술로 존재를 긍정받았다고 돼 있어.",
  },
  ...
  // ── 자브 ───────────────────────────────────────
  {
    ...
    elimsNote: "풀네임이 저렇게 긴 강아지야. 소원의 돌 경주를 하러 왔는데 이미 끝났다는 게... 어찌 보면 테런답지.",
