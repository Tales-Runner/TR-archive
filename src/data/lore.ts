...
export const STORY_ARCS: StoryArc[] = [
  ...
  },
  {
    ...
    characters: ["티티"],
    storyTags: ["라스트 카오스"],
    summary: "카오스 시리즈의 대미. 악마 신전이 붕괴하고, 연금술사 티티가 새롭게 등장한다. '짙어지는 어둠의 기운' 최종 맵에서 에필로그 이벤트가 펼쳐진다.",
    elimsComment: "카오스 시리즈의 끝이야. 오래 이어져 온 어둠의 이야기가 드디어 막을 내렸지. 티티라는 새 얼굴도 등장했고.",
    rComment: "카오스가... 끝났다는 건가요? 정말 긴 이야기였어요.",
  },
  {
    id: "zarb-adventure",
    title: "자브의 동화나라 적응기",
    ...
    characters: ["자브"],
    storyTags: ["자브"],
    summary: "새로운 스토리 캐릭터 자브가 동화나라에 도착하여 적응해 나가는 이야기.",
    elimsComment: "자브라... 동화나라에 새로 온 녀석이야. 적응하는 모습이 꽤 재미있지.",
  },
  {
    id: "tales-atelier",
    title: "테일즈 아틀리에",
    ...
    hasVideo: false,
    characters: [],
    storyTags: ["테일즈아틀리에", "테일즈 아틀리에"],
    summary: "미술관을 배경으로 한 시즌 채널. 비반트 뮤지엄, 이스케이프 뮤지엄, 페인트 러쉬, K의 명작: 삼나무 밀밭, 걸작: 오시아스의 밤, 미완의 아라베스크 등 다양한 맵이 등장한다.",
    elimsComment: "미술관이라... 개발자 K가 또 기상천외한 실험을 벌인 모양이야. 그림 속 세계가 꽤 위험하더군.",
    rComment: "미술관에서 달리기를요? 작품들이 움직인다니... 무서워요.",
  },
  {
    id: "knights-2026",
    title: "2026 꽃보다 기사",
    ...
    hasVideo: false,
    characters: [],
    storyTags: ["꽃보다 기사", "2026 꽃보다 기사"],
    summary: "8년 만에 돌아온 꽃보다 기사 시리즈. 카멜롯 아레나에서 세 팀이 격돌하고, 요정 여왕 모르간이 새롭게 등장한다.",
    elimsComment: "꽃보다 기사의 귀환이라. 8년 전 기사들이 돌아왔어. 모르간이라는 새 인물도 흥미롭지.",
    rComment: "기사님들이 돌아왔어요! 모르간 씨는... 좀 장난기가 있으시네요.",
  },
];
